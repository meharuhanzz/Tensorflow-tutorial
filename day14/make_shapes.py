"""Generates a synthetic 3-class image dataset (circles / squares /
triangles), randomized in position, size, color, and rotation, on noisy
backgrounds -- a genuine "the model must learn the SHAPE, not a shortcut
like color" task, unlike Day 7's color-only sample images.
